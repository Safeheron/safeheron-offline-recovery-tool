...
export const SUPPORTED_BLOCKCHAIN = [EVM_CHAIN, BITCOIN_CHAIN, BITCOIN_TEST_CHAIN, BITCOIN_CASH_CHAIN, DASH_CHAIN, TRON_CHAIN, NEAR_CHAIN, FIL_CHAIN, SUI_CHAIN, APTOS_CHAIN, SOLANA_CHAIN, TON_CHAIN, TON_TEST_CHAIN, LTC_CHAIN, LTC_TEST_CHAIN, DOGE_CHAIN, DOGE_TEST_CHAIN] as const
